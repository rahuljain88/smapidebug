...
gradlePlugin {
    (plugins) {
        register("com.smapi.aspectj") {
            id = "com.smapi.aspectj"
            implementationClass = "com.smapi.plugin.AspectJWrapper\$Standard"
        }

        register("com.smapi.aspectj-dryRun") {
            id = "com.smapi.aspectj-dryRun"
            implementationClass = "com.smapi.plugin.AspectJWrapper\$DryRun"
        }

        register("com.smapi.aspectj-ext") {
            id = "com.smapi.aspectj-ext"
            implementationClass = "com.smapi.plugin.AspectJWrapper\$Extended"
        }

        register("com.smapi.aspectj-provides") {
            id = "com.smapi.aspectj-provides"
            implementationClass = "com.smapi.plugin.AspectJWrapper\$Provides"
        }

        register("com.smapi.aspectj-junit") {
            id = "com.smapi.aspectj-junit"
            implementationClass = "com.smapi.plugin.AspectJWrapper\$Test"
        }
    }
}
