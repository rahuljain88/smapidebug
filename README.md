...
[![AspectJ](https://img.shields.io/badge/AspectJ-4.1.0-brightgreen.svg)](http://www.eclipse.org/aspectj/) [![Kotlin](https://img.shields.io/badge/Kotlin-1.3.71-blue.svg)](http://kotlinlang.org) [ ![Download](https://api.bintray.com/packages/archinamon/maven/android-gradle-aspectj/images/download.svg) ](https://bintray.com/archinamon/maven/android-gradle-aspectj/_latestVersion)<br />
...
Actual version supporting of AGP 3.6.+: `com.smapi:android-gradle-aspectj:4.1.0`.<br />
<br />
...
```kotlin
classpath("com.smapi:android-gradle-aspectj:3.4.5")
```
...
* implementing `com.smapi.aspectj-junit` plugin supporting weaving unit tests;
* `com.smapi.aspectj-test` has been removed as not working legacy sh$t;
...
* `com.smapi.aspectj-ext` plugin added to properly weave inpath jars, in this mode InstantRun doesn't allowed;
